 ...
 * @returns {{}}
 */
function pick(object, oiter, context) {
    var result = {}, obj = object, iter, keys;
    ...
    for (var i = 0, length = keys.length; i < length; i++) {
        var key = keys[i];
        var value = obj[key];
        if (iter(value, key, obj)) result[key] = value;
    }
...
function isNumber(obj) {
    //_type(NaN)值为'number
    return !Number.isNaN(obj) && _type(obj) === 'number';
}
...
function _type(obj) {
    ...
    typeof obj === 'function' ? class2type[Object.prototype.toString.call(obj)] ||
        'object' : typeof obj;
}